...
function research(){
    ...
    if(word == "GETELEMENTBYID" || word == "QUERYSELECTOR" || word == "GETELEMENTBYID()" || word == "INPUT" || word == "QUERYSELECTOR()"){
        document.querySelector('#output').innerHTML = "&nbsp;";
        document.querySelector('#output').innerText = ' cin >> variavel;';
    }else
    if(word == "FUNCTION" || word == "FUNCTION()") {
        document.querySelector('#output').innerHTML = "&nbsp;";
        document.querySelector('#output').innerText = 'function(){ }';
    }
    else{
        document.querySelector('#output').innerHTML = "&nbsp;";
...
function conversor(){
    ...
    var name = "var nome = 'jose'";
    alert(name.replace("var", "char"));
